...
module.exports = "app-main {\n  position: relative;\n  padding: 2.4rem 3.7rem;\n  width: calc(100% - 7rem);\n  height: 100%;\n}\n\napp-sidebar {\n  position: fixed;\n  top: 0;\n  right: 0;\n  width: 35rem;\n  height: 100%;\n  background: #F1EDE6;\n  flex: 0 0 auto;\n  transition: 0.3s;\n  -webkit-transform: translateX(28rem);\n          transform: translateX(28rem);\n  display: flex;\n}\n\napp-sidebar.is-open {\n  -webkit-transform: translateX(0);\n          transform: translateX(0);\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getOpen = function (data) {
        this.isOpen = data;
    };
...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.getTask = function (tit, level) {
        level = (!level) ? '0' : level;
        this.taskList.push({
            tit: tit,
            level: level
...
module.exports = ".header {\n  position: relative;\n  color: #003ca1;\n  font-size: 1.75rem;\n}\n.header h1 {\n  font-weight: bold;\n}\n.header .time {\n  position: absolute;\n  top: 0;\n  left: 50%;\n  -webkit-transform: translateX(-50%);\n          transform: translateX(-50%);\n}\n.main {\n  position: relative;\n  height: 90%;\n  display: flex;\n  justify-content: space-around;\n  align-items: center;\n}\n.row {\n  position: relative;\n}\n.row:nth-child(1) {\n  width: 30rem;\n  flex: 0 1 auto;\n}\n.row:nth-child(2) {\n  flex: 0 1 auto;\n}\n.row:nth-child(3) {\n  width: 27.5rem;\n  flex: 0 1 auto;\n  align-self: flex-end;\n  padding-bottom: 5rem;\n}\n.clock {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  -webkit-transform: translate(-50%, -50%);\n          transform: translate(-50%, -50%);\n  width: 100%;\n  height: 100%;\n}\n.clock-main {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  -webkit-transform: translate(-50%, -50%);\n          transform: translate(-50%, -50%);\n  width: 23.5rem;\n  height: 23.5rem;\n  border-radius: 50%;\n  background-color: #003ca1;\n}\n.clock-main .point {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  width: 0.2rem;\n  height: 0.8rem;\n  background: #F5F1EE;\n  -webkit-transform-origin: 100% 0%;\n          transform-origin: 100% 0%;\n  -webkit-transform: rotate(180deg) translateY(9.5rem);\n          transform: rotate(180deg) translateY(9.5rem);\n}\n.clock-min {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  -webkit-transform: translate(-50%, -50%) rotate(310deg);\n          transform: translate(-50%, -50%) rotate(310deg);\n  margin-left: -6.45rem;\n  width: 12.9rem;\n  height: 25.8rem;\n  border-radius: 100% 0% 0% 100%/50% 0% 0% 50%;\n  border: 0.15rem solid #003ca1;\n  background-color: rgba(245, 241, 238, 0.8);\n  -webkit-transform-origin: 100% 50%;\n          transform-origin: 100% 50%;\n}\n.clock-hour {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  -webkit-transform: translate(-50%, -50%) rotate(0deg);\n          transform: translate(-50%, -50%) rotate(0deg);\n  margin-left: -7.5rem;\n  width: 15rem;\n  height: 30rem;\n  border-radius: 100% 0% 0% 100%/50% 0% 0% 50%;\n  border: 0.15rem solid #003ca1;\n  background: #f5f1ee;\n  -webkit-transform-origin: 100% 50%;\n          transform-origin: 100% 50%;\n  font-size: 4rem;\n  text-align: center;\n  line-height: 30rem;\n  color: #003CA1;\n}\n.btns {\n  margin-top: 40rem;\n  text-align: center;\n}\n.btns .btn {\n  display: inline-block;\n  vertical-align: middle;\n  margin: 0.8rem;\n}\n.btns-start {\n  width: 13rem;\n  line-height: 3.5rem;\n  text-align: center;\n  font-weight: bold;\n  border: 0.15rem solid #003ca1;\n  border-radius: 0.5rem;\n  font-size: 2rem;\n}\n.btns-cancle {\n  width: 2.25rem;\n  height: 2.25rem;\n  background-color: #003ca1;\n  -webkit-mask-image: url(\"https://ionicons.com/ionicons/svg/md-close-circle-outline.svg\");\n}\n.btns-reset {\n  width: 2.25rem;\n  height: 2.25rem;\n  background-color: #003ca1;\n  -webkit-mask-image: url(\"https://ionicons.com/ionicons/svg/md-refresh.svg\");\n}\n.dots li {\n  width: 2.8rem;\n  height: 2.8rem;\n  border: 0.15rem solid #003CA1;\n  border-radius: 50%;\n  margin: 2.5rem;\n  font-size: 1.5rem;\n}\n.dots li.is-on {\n  background: #003CA1;\n}\n.task {\n  color: #003CA1;\n}\n.task-tit {\n  font-size: 2.5rem;\n  text-align: right;\n}\n.task-tit i {\n  display: inline-block;\n  width: 2rem;\n  height: 2rem;\n  background-color: #003ca1;\n  -webkit-mask-image: url(\"https://ionicons.com/ionicons/svg/md-arrow-dropdown-circle.svg\");\n}\n.task-cont {\n  margin-top: 0.8rem;\n  padding: 2rem 1.5rem;\n  font-size: 1.5rem;\n  line-height: 2;\n  box-shadow: 1px 0.3rem 0.3rem rgba(0, 0, 0, 0.16);\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.ngOnInit = function () {
        ...
        this.updateTime = setInterval(function () { _this.getTime('Asia/Taipei'); }, 5000);
        this.taskList = this.appService.taskList;
    };
    MainComponent.prototype.getTime = function (area) {
        // tslint:disable-next-line: one-variable-per-declaration
        var date = new Date(), time = date.toLocaleString('en-US', {
            timeZone: area,
            hour12: false,
            hour: 'numeric',
            minute: 'numeric'
...
var TaskComponent = /** @class */ (function () {
    function TaskComponent(appService) {
        this.appService = appService;
        this.taskList = [];
    }
    ...
    TaskComponent.prototype.onKey = function (e) {
